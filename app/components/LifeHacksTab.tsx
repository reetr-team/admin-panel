...
export default function LifeHacksTab({
  ...
  const [expandedActiveCategories, setExpandedActiveCategories] = useState<Set<string>>(new Set());
  const [expandedArchivedCategories, setExpandedArchivedCategories] = useState<Set<string>>(new Set());
  ...
  const handleArchiveToggle = async (lifeHack: any) => {
    ...
    try {
      ...
      setToast({
        message: `Life hack ${newActiveState ? "unarchived" : "archived"} successfully!`,
        type: "success"
      });
    ...
    <>
      ...
      {activeSubTab === "edit" && !editingLifeHack && (
        <div>
          ...
          <div className="mb-8">
            <h4 className="text-lg font-medium text-gray-900 mb-4">Active Life Hacks</h4>
            {activeLifeHacks.length === 0 ? (
              <p className="text-gray-500">No active life hacks found. Create some first!</p>
            ) : (
                            ...
                            <div key={lifeHack.id || index} className="border border-gray-200 rounded-lg p-4">
                              <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2">
                                  ...
                                  <button
                                    onClick={() => handleArchiveToggle(lifeHack)}
          ...
          <div>
            <h4 className="text-lg font-medium text-gray-900 mb-4">Archived Life Hacks</h4>
                  ...
                  return (
                    <div key={category}>
                      ...
                      {isExpanded && (
                        <div className="space-y-3 mb-4">
                          {(categoryLifeHacks as any[]).map((lifeHack: any, index: number) => (
                            <div key={lifeHack.id || index} className="border border-red-200 bg-red-50 rounded-lg p-4">
                              <div className="flex justify-between items-start">
                                <div>
